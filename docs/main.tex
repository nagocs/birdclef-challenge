...
\section{Módszertan}
 ...
 A tanítás során a teljesítmény növelése, illetve a tanítási idő csökkentése érdekében több különböző értékkel próbálkoztunk a tanulási ráta (learning rate) paraméter esetén. Az irodalomban fellelhető ajánlások alapján logaritmikus skála szerinti lépésekben változtattuk, azonban azt találtuk, hogy az eredetitől eltérő értékek nem jelentettek értékelhető javulást.
...
\begin{figure}[!t]
    \centering
    \subfloat[Veszteség alakulása]{\includegraphics[width=3.2in]{figures/training_loss.png}
    \label{fig_loss}}
    \hfil
    \subfloat[Pontosság alakulása]{\includegraphics[width=3.2in]{figures/training_accuracy.png}
    \label{fig_acc}}
...
{
\appendices
\section*{Generatív MI eszközök használata}
  A projekt megvalósítása során generatív mesterséges intelligenciát alkalmaztunk a dokumentáció elkészítésének és formázásának támogatására, valamint a Python-alapú megoldások fejlesztése során a megfelelő szintaxis és implementációs megoldások azonosításának elősegítésére.
}
